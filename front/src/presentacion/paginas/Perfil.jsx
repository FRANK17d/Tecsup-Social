    ...
    return (
        <div className="min-h-screen bg-[#0c1014] text-white">
            ...
            <main className="max-w-4xl mx-auto px-4 py-6">
                <Tarjeta>
                    {/* Banner */}
                    <div className="h-48 bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 rounded-t-xl opacity-80" />
                    ...
                    <TarjetaCuerpo className="-mt-16 pb-8">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-end gap-4">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-white capitalize">{usuario?.rol}</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#121212] border border-[#262626] rounded-xl p-6">
                                ...
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <p className="text-2xl font-bold text-indigo-500">0</p>
                                        <p className="text-sm text-white">Publicaciones</p>
                                    </div>
                                    <div>
                                        <p className="text-2xl font-bold text-green-500">0</p>
                                        <p className="text-sm text-white">Comentarios</p>
                                    </div>
                                    <div>
                                        <p className="text-2xl font-bold text-pink-500">0</p>
                                        <p className="text-sm text-white">Me gusta</p>
                                    </div>
                                </div>
                            </div>
                        </div>
